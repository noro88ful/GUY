...
<div class="main-content-inner">
	<table id="Home_1" tblName="Home_1" class="table table-striped table-dark table-bordered" style="width: 100%">
		<thead>
				<tr>
    ...
    <form method="post" action="/add_table_field" class="modal-content" enctype="multipart/form-data">
	 {{csrf_field()}}	
      ...
      <div class="modal-body forum_body">
			<input type="hidden" name="tblname" value="Home_1">
