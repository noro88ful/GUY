...
<div class="main-content-inner">
	<table id="Library" tblName="Library" class="table table-striped table-dark table-bordered" style="width: 100%">
		<thead>
				<tr>
		...
		<tbody>
				@foreach($libraries as $blog)
				<tr class='request_tr' trID="{{$blog->id}}">
					<td fvalue="{{$blog->text}}"><?php echo($blog->text) ?></td>
    ...
    <form method="post" action="/add_table_field" class="modal-content" enctype="multipart/form-data">
	 {{csrf_field()}}	
      ...
      <div class="modal-body forum_body">
			<input type="hidden" name="tblname" value="Library">
