...
<div class="main-content-inner">
	<table id="Contact_top" tblName="Contact_top" class="table table-striped table-dark table-bordered" style="width: 100%">
		<thead>
				<tr>
    ...
    <form method="post" action="/add_table_field" class="modal-content" enctype="multipart/form-data">
	 {{csrf_field()}}	
      ...
      <div class="modal-body forum_body">
			<input type="hidden" name="tblname" value="Contact_top">
			<div class="form-group"><input type="topic" class="form-control" placeholder="Վերնագիր" name="topic"></div>
